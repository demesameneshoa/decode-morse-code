...
```sh
  cd my-folder
  git clone https://github.com/demesameneshoa/decode-morse-code
```
-
...
Feel free to check the [issues page](https://github.com/demesameneshoa/decode-morse-code/issues).
...
If you like this project kindly drop this [repo](https://github.com/demesameneshoa/decode-morse-code) a star.
